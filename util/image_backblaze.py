...
def bbDownload(
    fileid, authorization_token=b2_api.account_info.get_account_auth_token()
):
    headers = None
...
if __name__ == "__main__":
    res = bbDownload(
        "4_zd8ad465646ca80c885dc0611_f114a3c2c5d61f98c_d20240209_m053417_c005_v0501010_t0021_u01707456857078"
    )
    print(res)
